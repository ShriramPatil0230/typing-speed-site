...
const Footer = () => {
  ...
  return (
    <div className="footer">
        <div className="links">
            <Link className='space' href="https://github.com/ShriramPatil0230?tab=repositories" underline="none" color="inherit">
            <GitHubIcon/>
            </Link>
            <Link className='space' href="https://www.linkedin.com/in/shriram-patil-b9411b1aa/" underline="none" color="inherit">
